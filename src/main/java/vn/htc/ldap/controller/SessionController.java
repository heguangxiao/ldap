...
public class SessionController extends AbstractBackEnConst {
    ...
    public String forgotPasswordView(ModelMap model, HttpServletRequest request, RedirectAttributes redrAtt) {
        model.put(TITLE, "Forgot password");
        return "forgot-password";
    }

    @PostMapping("/forgot-password")
    public String forgotPasswordProcess(ModelMap model, HttpServletRequest request, RedirectAttributes redrAtt) {
        model.put(TITLE, "Login");
        return "login";
    }
